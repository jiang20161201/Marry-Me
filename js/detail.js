            ...
            $(".public3_top").stop().animate({ "height": 380 }, 600, function() {
                $(".public3_bottom").fadeIn(200, function() {
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        var data = datas[idx];
                        var str = "<p class='style1'>" + data.name + "</p>" + "<p class='style2'>" + data.line1 + "</p>" + "<p class='style3'>" + data.line2 + "</p>" + "<p class='style4'>" + data.line3 + "</p>" + "<p class='style5'>" + data.line4 + "</p>"

                        $(".public3_top").html(str);

                        var str2 = "<p class='style6'>" + data.line5 + "</p>" + "<p class='style6'>" + data.line6 + "</p>" + "<p class='style6'>" + data.line7 + "</p>"
