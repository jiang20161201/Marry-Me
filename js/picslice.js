...
tab.prototype = { //原型
        ...
        flipPage: function(obj) { //翻页
            ...
            a.setStyle(oDivPage, {
                position: 'absolute',
                background: 'url(' + a.srcs[(a.now)] + ') right no-repeat',
                zIndex: 3,
                left: '50%',
                top: 0,
                width: '50%',
...
$(function() {
    ...
    //添加小动画html标签
    $(".btnstyle").append("<span class='line line-top'></span>" + "<span class='line line-right'></span>" + "<span class='line line-bottom'></span>" + "<span class='line line-left'></span>");
